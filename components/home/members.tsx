      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
        ...
        >
          ...
          <p className="text-xl text-white leading-relaxed max-w-xl mb-14">
            Meet the developers, designers, and creators powering the Malaysian
            Solana ecosystem. Every member here has shown up, shipped work, and
            earned their place in the community.
          </p>
