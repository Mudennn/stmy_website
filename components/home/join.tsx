    ...
    return (
        <section className="pt-24 lg:pt-36">
            <div className="relative w-full mx-auto overflow-hidden group">
                ...
                {/* Main Container */}
                <div className="relative w-full bg-background min-h-[400px] lg:min-h-[785px] flex items-center overflow-hidden">

                    {/* SVG Bevel Overlay - Top Right */}
                    <div className="absolute top-0 right-0 pointer-events-none z-5">
                        {/* Desktop */}
                        <svg className="hidden lg:block w-[450px] h-[120px]" viewBox="0 0 450 120" fill="var(--background)" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 0 L120 120 L450 120 L450 0 Z" />
                        </svg>
                        {/* Mobile */}
                        {/* <svg className="block lg:hidden w-[250px] h-[80px]" viewBox="0 0 250 80" fill="var(--background)" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="absolute bottom-10 left-1/2 -translate-x-1/2 lg:left-auto lg:right-60 lg:translate-x-0 lg:bottom-20 flex items-center justify-center lg:justify-start gap-4">
                        <a href="#" className="w-20 h-20 flex items-center justify-center border border-white/20 bg-white/5 hover:bg-white transition-all rounded-none backdrop-blur-sm group/btn">
                            <Twitter size={32} className='text-white group-hover/btn:text-primary transition-colors duration-300' />
                        </a>
                        <a href="#" className="w-20 h-20 flex items-center justify-center border border-white/20 bg-white/5 hover:bg-white transition-all rounded-none backdrop-blur-sm group/btn">
                            <Send size={32} className='text-white group-hover/btn:text-primary transition-colors duration-300' />
                        </a>
                        <a href="#" className="w-20 h-20 flex items-center justify-center border border-white/20 bg-white/5 hover:bg-white transition-all rounded-none backdrop-blur-sm group/btn">
                            <Disc size={32} className='text-white group-hover/btn:text-primary transition-colors duration-300' />
                        </a>
                    </div>
